...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      console.log('✅ Added OAuth and profile user columns successfully');
    } catch (error) {
      await transaction.rollback();
      console.error('❌ Error adding OAuth and profile user columns:', error);
      throw error;
    }
  },
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await transaction.commit();
      console.log('✅ Removed OAuth and profile user columns successfully');
    } catch (error) {
      await transaction.rollback();
      console.error('❌ Error removing OAuth and profile user columns:', error);
      throw error;
    }
  }
};
