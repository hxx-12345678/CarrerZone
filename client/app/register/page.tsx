                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 pr-10 h-12 border-slate-200 dark:border-slate-600 focus:border-blue-500 bg-white dark:bg-slate-700 ${formData.password && passwordErrors.length > 0 ? 'border-red-500' : ''
                            }`}
                          required
                        />
                        <button
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            <div className="flex-1 h-2 bg-slate-200 rounded-full overflow-hidden">
                              <div
                                className={`h-full transition-all duration-300 ${passwordStrength === 'weak' ? 'bg-red-500 w-1/4' :
